<table style="width: 100%; border: 1px solid black; border-collapse: collapse">
	<thead>
		<tr>
			...
			<th height="40" style="border: 1px solid black; width: 10%">{{ __('app.reports.dsr.monthly_target') }}</th>
	...
	<tbody>
		...
		<tr>
			@if ($channels == 'TOTAL')
			<td height="40" style="border: 1px solid black; padding-left: 5px" class="total">{{ $channels }}</td>
			...
			<td height="40" align="right"
				style="border: 1px solid black; padding-right: 5px; color: white; background: {{ $channel['index_archive'] < 50 ? 'red' : 'green' }}">
