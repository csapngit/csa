  ...
  var datagrid = function () {
    ...
    var datatable = $('#kt_datatable').KTDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url: '/api/rebate/get/list/manual/' + userid,
            method: 'GET'
          }
        },
        pageSize: 10,
      ...
      columns: [{
        ...
        textAlign: 'center',
        template: function (data) {
          return "<span class='label " + data.style + "'>" + data.statusdesc + "</span>";
        }
      }, {
        field: 'Actions',
        title: 'Actions',
        ...
        template: function (raw) {
          return '\
        <a href="/rebate/manual/' + raw.id + '/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
