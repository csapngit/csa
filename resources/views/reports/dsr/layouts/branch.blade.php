<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td class="total value">{{ round($dsr['index_archive'], 2) }}{{ __('app.operators.percentage') }}</td>
			...
			<td class="value" style="color: white; background: {{ $dsr['index_archive'] < $dates['timegone_index'] ? 'red' : 'green' }}">
